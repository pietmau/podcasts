...
@Singleton
@Component(modules = {AppModule.class, ApiLevelCheckerlModule.class, SearchModelsModule.class,
        ImageLoaderModule.class, TransitionsModule.class, MediaModule.class, RepositoryModule.class,
        ApiModule.class})
