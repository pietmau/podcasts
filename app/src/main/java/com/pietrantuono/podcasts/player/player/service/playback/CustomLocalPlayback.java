 ...
 * ExoPlayer}
 */
public final class CustomLocalPlayback implements Playback {

    private static final String TAG = LogHelper.makeLogTag(CustomLocalPlayback.class);
    ...
    private final PodcastProvider mMusicProvider;
    ...
    public CustomLocalPlayback(Context context, PodcastProvider musicProvider) {
