...
import com.pietrantuono.podcasts.player.player.service.playbacknotificator.IntentManager

class BroadcastManager(private val intentManager: IntentManager) {
