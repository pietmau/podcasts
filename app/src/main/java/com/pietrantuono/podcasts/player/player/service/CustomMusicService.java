...
import com.example.android.uamp.PackageValidator;
...
public class CustomMusicService extends MusicService implements
        PlaybackManager.PlaybackServiceCallback {

    private static final String TAG = LogHelper.makeLogTag(CustomMusicService.class);
    ...
    public void onPlaybackStart() {
        ...
        startService(new Intent(getApplicationContext(), CustomMusicService.class));
    }
    ...
    private static class DelayedStopHandler extends Handler {
        private final WeakReference<CustomMusicService> mWeakReference;

        private DelayedStopHandler(CustomMusicService service) {
            mWeakReference = new WeakReference<>(service);
        }

        @Override
        public void handleMessage(Message msg) {
            CustomMusicService service = mWeakReference.get();
    ...
    private class CastSessionManagerListener implements SessionManagerListener<CastSession> {
        ...
        public void onSessionEnded(CastSession session, int error) {
            ...
            mSession.setExtras(mSessionExtras);
            Playback playback = new LocalPlayback(CustomMusicService.this, mMusicProvider);
        ...
        public void onSessionStarted(CastSession session, String sessionId) {
            ...
            Playback playback = new CastPlayback(mMusicProvider, CustomMusicService.this);
