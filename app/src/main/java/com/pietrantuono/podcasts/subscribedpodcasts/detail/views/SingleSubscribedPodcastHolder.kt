...
class SingleSubscribedPodcastHolder(itemView: View, private val resources: ResourcesProvider,
    ...
    SingleSubscribedPodcastsAdapter.OnItemClickedClickedListener, position: Int) {
    ...
    private fun setUpClickListener(podcast: SinglePodcast?, position: Int, listener: SingleSubscribedPodcastsAdapter.OnItemClickedClickedListener) {
