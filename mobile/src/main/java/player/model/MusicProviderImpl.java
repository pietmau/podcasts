...
import static player.utils.MediaIDHelper.MEDIA_ID_ROOT;
import static player.utils.MediaIDHelper.createMediaID;
...
public class MusicProviderImpl implements MusicProvider {
    ...
    private static final String TAG = LogHelper.makeLogTag(MusicProviderImpl.class);
    ...
    public MusicProviderImpl(MusicProviderSource source) {
        mSource = source;
